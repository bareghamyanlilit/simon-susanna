...
export function Home() {
  ...
  return (
    ...
    >
      ...
      <p className={` ${openEnvelope ? "opacity-0" : ""} z-60 absolute bottom-20 text-vrayi font-bold left-1/2 -translate-x-1/2 `}>Սիրով <br />Սիմոն և Սուսաննա</p>
      ...
      <div className="mx-auto max-w-md ">
        {/* arajin mas */}
        <div className="px-3">
          <motion.h2 {...anim} className="text-center text-[26px] font-fold mt-25">
            {name[0]} և {name[1]}
          </motion.h2>
        ...
        <motion.p {...anim} className=" text-2xl mt-10 mb-20 ">
          {txt6}
        </motion.p>
